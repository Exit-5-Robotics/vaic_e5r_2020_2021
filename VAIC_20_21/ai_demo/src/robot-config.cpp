...
motor         botRoller(PORT1, ratio18_1, false);
motor         topRoller(PORT2, ratio18_1, false);
motor         backLeftWheel(PORT16, ratio18_1, false);
motor         frontLeftWheel(PORT17, ratio18_1, false);
motor         backRightWheel(PORT18, ratio18_1, true);
motor         frontRightWheel(PORT19, ratio18_1, true);
